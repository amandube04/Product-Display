        ...
        <div className="bg-gray-100 rounded-sm p-4 h-max">
          ...
          <div className="mt-5 flex gap-2">
            <button
              ...
              className="disabled:opacity-60 text-sm px-4 py-3 bg-black text-white font-extrabold cursor-pointer"
            >
              Checkout
            </button>
            <button
              onClick={() => navigate("/products")}
              className="text-sm px-4 py-3 bg-black text-white font-extrabold cursor-pointer"
            >
              Continue Shopping
            </button>
          </div>
